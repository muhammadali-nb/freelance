  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mb-6 text-center text-foreground">О нас</h1>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4 text-foreground">Наши ценности</h2>
        <ul className="list-disc list-inside mb-8 text-base md:text-lg text-muted-foreground">
