  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-2xl">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-center">Свяжитесь с нами</h1>
        ...
        <div className="text-center">
          ...
          <p className="text-lg mb-2">Email: info@freelance-site.ru</p>
          <p className="text-lg mb-2">Телефон: +7 (999) 123-45-67</p>
          <p className="text-lg">Адрес: г. Москва, ул. Примерная, д. 123</p>
        </div>
      </div>
    </div>
  );
