						...
						{isAuthenticated && user ? (
							<div className="mt-6 pt-6 border-t border-gray-200">
								...
								<div className="space-y-1">
									<MobileMenuItem href="/profile" icon={User} onClick={toggleMenu}>
										Профиль
									</MobileMenuItem>
									<MobileMenuItem href="/settings" icon={Settings} onClick={toggleMenu}>
										Настройки
									</MobileMenuItem>
									<MobileMenuItem href="/projects" icon={Briefcase} onClick={toggleMenu}>
										Мои проекты
									</MobileMenuItem>
									<button
										onClick={handleLogout}
